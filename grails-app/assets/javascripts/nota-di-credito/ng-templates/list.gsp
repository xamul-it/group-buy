	...
	<div dropdown class="dropdown pull-left">
			<h1 dropdown-toggle>Note di credito 2014 <span class="caret"></span></h1>
	...
	<div class="buttons" role="group">
		...
		<a role="button" class="btn btn-sm btn-success" data-ng-href="#create"><i class="glyphicon glyphicon-plus"></i> Nuova nota di credito</a>
	</div>
</div>
