	...
	<div dropdown class="dropdown pull-left">
			<h1 dropdown-toggle>Preventivo 2014 <span class="caret"></span></h1>
	...
	<div class="buttons" role="group">
		...
		<a role="button" class="btn btn-sm btn-success" data-ng-href="#create"><i class="glyphicon glyphicon-plus"></i> Nuovo preventivo</a>
	</div>
</div>
	...
	<div class="filtro">
		...
		<i class="glyphicon glyphicon-filter"></i>
			...
			<gas-status-filter filter="3">Accettati</gas-status-filter>
			<gas-status-filter filter="1">Inviati</gas-status-filter>
			<gas-status-filter filter="2">Scaduti</gas-status-filter>
