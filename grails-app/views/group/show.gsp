...
<html>
    ...
    <body>
        ...
        <div id="show-group" class="content scaffold-show" role="main">
            ...
            <f:display bean="group" />
            <g:form resource="${this.group}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.group}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
