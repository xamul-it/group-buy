                                        ...
                                        <div class="text-warning">
                                            <ul class="list-unstyled list-inline mt-3">
                                                <li class="list-inline-item">
                                                    <a href="https://www.linkedin.com/in/luigizanderighi/" target="_blank" title="Linkedin" class="btn-floating btn-sm rgba-white-slight mx-1 waves-effect waves-light">
                                ...
                                <div class="card-body">
                                    <div class="team-section text-center">
                                        ...
                                        <div class="text-warning">
                                            <ul class="list-unstyled list-inline mt-3">
                                                <li class="list-inline-item">
                                                    <a href="https://www.linkedin.com/in/luciaalpago/" target="_blank" title="Linkedin" class="btn-floating btn-sm rgba-white-slight mx-1 waves-effect waves-light">
                                                        <i class="fa fa-linkedin bg-linkedin"></i>
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="card-body">
                                    <div class="team-section text-center">
                                        ...
                                        <div class="text-warning">
                                            <ul class="list-unstyled list-inline mt-3">
                                                <li class="list-inline-item">
                                                    <a href="https://github.com/aberbenni/" target="_blank" title="GitHub" class="btn-floating btn-sm rgba-white-slight mx-1 waves-effect waves-light">
                                                        <i class="fa fa-github github-bg"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="https://www.linkedin.com/in/aberbenni/" target="_blank" title="Linkedin" class="btn-floating btn-sm rgba-white-slight mx-1 waves-effect waves-light">
                                                        <i class="fa fa-linkedin bg-linkedin"></i>
                                                    </a>
                                                </li>
                                            </ul>
