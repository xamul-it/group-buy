                    ...
                    <div class="container">
                            ...
                            <v-collapse-group :onlyOneActive="false">
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper :active="true" v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Non ho un gruppo d’acquisto ma mi piacerebbe unirmi a qualcuno, posso farlo?</a> </h4>
                                        </div>
                                        <div class="panel-collapse active collapse" :class="{show: sp.status}" v-collapse-content>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Non ho un gruppo d’acquisto ma mi piacerebbe effettuare acquisti su ProprioOui, posso farlo?</a> </h4>
                                        </div>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Il gruppo deve necessariamente avere un indirizzo?</a> </h4>
                                        </div>
                                        <div class="panel-collapse show" v-collapse-content>
                                            <div class="panel-body bg-white text-dark">
                                                <p>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Dove è disponibile il servizio?</a> </h4>
                                        </div>
                                        <div class="panel-collapse show" v-collapse-content>
                                            <div class="panel-body bg-white text-dark">
                                                <p>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Non trovo il mio negozio di fiducia, posso aggiungerlo?</a> </h4>
                                        </div>
                                        <div class="panel-collapse show" v-collapse-content>
                                            <div class="panel-body bg-white text-dark">
                                                <p>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Sono un negoziante, come posso partecipare?</a> </h4>
                                        </div>
                                        <div class="panel-collapse show" v-collapse-content>
                                            <div class="panel-body bg-white text-dark">
                                                <p>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Sono un negoziante, vorrei aggiornare la mia scheda, come posso farlo?</a> </h4>
                                        </div>
                                        <div class="panel-collapse show" v-collapse-content>
                                            <div class="panel-body bg-white text-dark">
                                                <p>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Quali tipologie di attività sono presenti?</a> </h4>
                                        </div>
                                        <div class="panel-collapse show" v-collapse-content>
                                            <div class="panel-body bg-white text-dark">
                                                <p>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Gestite la consegna / spedizione?</a> </h4>
                                        </div>
                                        <div class="panel-collapse show" v-collapse-content>
                                            <div class="panel-body bg-white text-dark">
                                                <p>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}">Quali sistemi di pagamento sono disponibili?</a> </h4>
                                        </div>
                                        <div class="panel-collapse show" v-collapse-content>
                                            <div class="panel-body bg-white text-dark">
                                                <p>
                                ...
                                <div class="panel panel-default mb-4 border p-0">
                                    <v-collapse-wrapper v-slot:default="sp">
                                        <div class="panel-heading1" v-collapse-toggle>
                                            <h4 class="panel-title1"> 
                                                <a class="accordion-toggle" :class="{collapsed: !sp.status}"> ?</a> </h4>
                                        </div>
                                        <div class="panel-collapse show" v-collapse-content>
                                            <div class="panel-body bg-white text-dark">
                                                <p>
