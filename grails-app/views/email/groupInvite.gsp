							...
							<div style="border-collapse: collapse;display: table;width: 100%;background-color:#ffffff;">
								...
								<div class="col num3"
									...
									<div class="col_cont" style="width:100% !important;">
										<!--[if (!mso)&(!IE)]><!-->
										<div
											style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 10px;">
											<!--<![endif]-->
											<div align="center"
												...
												<div style="font-size:1px;line-height:20px"> </div><a
													...
													target="_blank"> <img align="center" alt="${toGroup.name}" title="${toGroup.name}" border="0"
														...
														title="${toGroup.name}" width="128" /></a>
