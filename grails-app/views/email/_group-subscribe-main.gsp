											...
											<tr>
												<td class="p30-20" style="padding: 80px 50px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															<td class="text white center" style="padding-bottom: 25px; font-family:'Lato', Arial, sans-serif; font-size:16px; line-height:28px; min-width:auto !important; color:#ffffff; text-align:center;">Stai entrando a far parte del gruppo, guarda gli <a style="color:#ffffff" href="${basePath}/gruppo/${toGroup.id}/ordini"> ordini </a> o conosci gli altri <a style="color:#ffffff" href="${basePath}/gruppo/${toGroup.id}/iscritti"> partecipanti </a>.</td>
														</tr>
														<tr>
															<td align="center">
